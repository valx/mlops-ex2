...
git add README.md docs .gitignore mlops_example_2github/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[mlops_example_2github/databricks.yml](../mlops_example_2github/databricks.yml) file.
...
Follow the instructions in [mlops_example_2github/resources/README.md](../mlops_example_2github/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../mlops_example_2github/resources/README.md)  to propose, test, and deploy
