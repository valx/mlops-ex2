...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops_example_2github-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/staging/mlops_example_2github/mlops_example_2github-model)
* [Prod model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/prod/mlops_example_2github/mlops_example_2github-model)
. 
