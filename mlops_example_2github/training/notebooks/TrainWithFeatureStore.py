...
# ``mlops_example_2github/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-mlops_example_2github-experiment",
...
dbutils.widgets.text(
    "model_name", "dev.mlops_example_2github.mlops_example_2github-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.mlops_example_2github.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.mlops_example_2github.trip_dropoff_features",
