...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``mlops_example_2github/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in mlops_example_2github/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in mlops_example_2github/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-mlops_example_2github-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.mlops_example_2github.mlops_example_2github-model", "Full (Three-Level) Model Name")
